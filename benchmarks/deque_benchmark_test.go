...
import (
	...
	. "github.com/zelr0x/chainyq/benchmarks/internal/benchutil"
...
func BenchmarkChurnWithClear(b *testing.B) {
	...
	b.Run("chainyq.Deque_PoolSmallPrealloc", func(b *testing.B) {
		...
		d := deque.WithCfg[int](deque.DequeCfg{
			BlockSize: deque.SuggestBlockSize[int](),
			FrontCap:  8,
			BackCap:   8,
			Pooled:    true,
		})
